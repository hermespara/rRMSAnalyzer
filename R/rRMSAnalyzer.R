...
#' around the \code{SummarizedExperiment} object containing both RMS data and
#' samples metadata.
#'
#' The main functions are (in a standard workflow chronological order):
#'
#' \itemize{
#' \item \code{\link{load_ribodata}} - import data and create a \code{SummarizedExperiment}.
...
#' \item \code{\link{extract_data}} - get a dataframe of C-score for all samples and all positions
...
#'
#' @useDynLib rRMSAnalyzer, .registration = TRUE
