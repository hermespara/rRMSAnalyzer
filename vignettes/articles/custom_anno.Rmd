...
First, check if your RNAs inside your SummarizedExperiment have the same name as your RNAs in your annotation dataframe.

If not, you can use `rename_rna` to change the names inside the SummarizedExperiment or modify your annotation dataframe.

When this is done. You can use annotate_site :
```{r,eval=F}
# In this example, ribo is the SummarizedExperiment we want to annotate
